 ...
 * @author DELL
 */
public class check1 implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            String email = (String) request.getParameter("txtemail").trim();
            String fname = (String) request.getParameter("txtfname").trim();
            String lname = (String) request.getParameter("txtlname").trim();
            String phone = (String) request.getParameter("txtphone").trim();
            String gender = (String) request.getParameter("txtgender").trim();
            String password = (String) request.getParameter("txtpassword").trim();
            String username = (String) request.getParameter("txtlusername").trim();
            String c_password = (String) request.getParameter("txtc_password").trim();
            String address = (String) request.getParameter("txtaddress");
            String error = null;
            
            
                if (!UI.FormPassword(password) || !UI.FormPassword(c_password)) {
                    error = "Pls, Password must be least 8 chacracter and 1 special character";
                }
                if (!password.equals(c_password)) {
                    error = "Pls, Password must be same password above";
                }
                if (!UI.FormEmail(email.trim())) {
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("check1: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("check1(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("check1::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("check1::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("check1::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("check1::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("check1::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
